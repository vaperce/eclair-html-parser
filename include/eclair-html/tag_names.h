...
class TagName {
public:
  explicit TagName() : _ns(Namespaces::HTML), _kind(TagKinds::UNKNOWN) {}

  explicit TagName(TagKinds kind) : _ns(Namespaces::HTML), _kind(kind) {}
  ...
  Namespaces nameSpace() const { return _ns; }

  TagKinds kind() const { return _kind; }
  ...
  bool empty() const { return _kind == TagKinds::UNKNOWN && _name.empty(); }
  ...
  bool operator!=(const TagName& other) const { return !(*this == other); }

  bool operator!=(TagKinds kind) const { return !(*this == kind); }
