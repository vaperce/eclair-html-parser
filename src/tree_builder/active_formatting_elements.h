...
namespace html_parser {
  ...
  struct _FormattingElementItem {
    explicit _FormattingElementItem()
      : element(nullptr) {
    }

    explicit _FormattingElementItem(Node& element)
      : element(&element) {
    }
  ...
  public:
    ...
    ActiveFormattingElements(OpenElements& openElements,
        NodeInserter& inserter)
      : _openElements(openElements), _inserter(inserter) {
    }

    void addMarker() {
      _list.push_front(_FormattingElementItem());
    }
